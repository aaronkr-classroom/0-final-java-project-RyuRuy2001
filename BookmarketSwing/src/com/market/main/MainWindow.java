...
public class MainWindow extends JFrame{
	...
	private void menuIntroduction() {
		...
		bt2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(mCart.mCartCount == 0)
					JOptionPane.showConfirmDialog(bt2, "장바구니에 항목이 없습니다.", "장바구니 상품 목록 보기",
		...
		bt3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(mCart.mCartCount == 0)
					JOptionPane.showConfirmDialog(bt2, "장바구니에 항목이 없습니다.", "장바구니 비우기",
							JOptionPane.ERROR_MESSAGE);
				else {
					mPagePanel.removeAll();
		...
		bt6.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(mCart.mCartCount == 0)
					JOptionPane.showConfirmDialog(bt3, "장바구니에 항목이 없습니다.", "장바구니 비우기",
							JOptionPane.ERROR_MESSAGE);
				else {
		...
		bt7.addActionListener(new ActionListener() {
			public void actionPerFormed(ActionEvent e) {
				...
				if (mCart.mCartCount == 0)
					...
					mPagePanel.removeAll();
					mPagePanel.add("주문 배송지", new CartShippingPage(mPagePanel, null));
					mPagePanel.revalidate();
					mPagePanel.repaint();
				}
			}
		...
		bt8.addActionListener(new ActionListener( ) {
			...
			bt9.addActionListener(new ActionListener() {
				public void actionperformed(ActionEvent e) {
					...
					JFrame = new JFrame();
					adminDialog = new AdminLoginDialog(JFrame, "관리자 로그인");
	...
	private void menuCartClear(JButton button) {
		...
		if (mCart.mCartCount == 0) 
			JOptionPane.showMessageDialog(button, "장박니에 항목이 없습니다.");
		else {
