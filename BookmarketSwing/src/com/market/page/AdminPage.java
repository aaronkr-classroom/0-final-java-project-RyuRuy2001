...
public class AdminPage extends JPanel{
	...
	public AdminPage(JPanel panel) {
		...
		pricePanel.setBounds(100, 50, 700, 50);
		JLabel priceLabel = new JLabel("도서명 :");
		...
		descPanel.setBounds(100, 150, 700, 50);
		...
		categoryPanel.setBounds(100, 150, 700, 50);
		...
		datePanel.setBounds(100, 150, 700, 50);
		...
		okButton.addActionListener(new AbstractAction() {
			public void actionPerformed1(ActionEvent e) {
				...
				writeBook[1] = idTextField.getText();
				writeBook[2] = nameTextField.getText();
				writeBook[3] = priceTextField.getText();
				writeBook[4] = authorTextField.getText();
				writeBook[5] = descTextField.getText();
				writeBook[6] = categoryTextField.getText();
				writeBook[7] = dateTextField.getText();
				try {
